...
// Constants
//
const loadURL = 'https://localhost:9000/v2/load'
const saveURL = 'https://localhost:9000/v2/save'
...
function load(name, onSuccessFn) {
    ...
    /*
        const options = {
            ...
            credentials: 'include',  // Include credentials (cookies) in the request if needed
        };
    */
    const options = {
        method: 'POST',
