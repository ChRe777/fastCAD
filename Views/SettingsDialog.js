...
`
const template = `
<div ref="settings-modal" class="modal" tabindex="-1">
...
export default {
  ...
  watch: {
    'store.showSettings'() {
      console.log('store.showSettings')
      this.modal.show()
    }
  },
  methods: {
  ...
  mounted() {
    const ref = this.$refs['settings-modal']
    this.modal = new bootstrap.Modal(ref, { keyboard: false })
  }
}